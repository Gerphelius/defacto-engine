...
static DF::String MissionStageToStr(Mission::Stage::Type stage)
{
    switch (stage)
    {
        case Mission::Stage::PENDING:
        {
            return DF::String("PENDING");
        }
        case Mission::Stage::SURVEILLANCE:
        {
            return DF::String("SURVEILLANCE");
        }
        case Mission::Stage::SECURING:
        {
            return DF::String("SECURING");
        }
        default:
        {
...
static DF::String ContainmentClassToStr(SCP::ContainmentClass containmentClass)
{
    switch (containmentClass)
    {
        case SCP::ContainmentClass::SAFE:
        {
            return DF::String("SAFE");
        }
        case SCP::ContainmentClass::EUCLID:
        {
            return DF::String("EUCLID");
        }
        case SCP::ContainmentClass::KETER:
        {
...
static void CreateMissionsUI(DF::GameMemory* gameMemory)
{
    ...
    //                    {
    //                        .layout = {
    //                            .sizing = {.width = CLAY_SIZING_GROW(0), .height =
    //                            CLAY_SIZING_FIXED(0) }, .childGap = 16, .layoutDirection =
    //                            CLAY_LEFT_TO_RIGHT,
    //                        },
    //                    })
    //            {
    ...
    //                        {
    //                            .layout = {
    //                                .sizing = {.width = CLAY_SIZING_FIXED(100), .height =
    //                                CLAY_SIZING_FIXED(20) }, .padding = CLAY_PADDING_ALL(2),
    //                                .childGap = 2,
    //                                .layoutDirection = CLAY_LEFT_TO_RIGHT,
    //                            },
    ...
    //                        CLAY_AUTO_ID({
    //                                .layout = {
    //                                    .sizing = { .width = CLAY_SIZING_PERCENT(progress /
    //                                    100.0f), .height = CLAY_SIZING_GROW(0) },
    //                                },
    ...
    //                    .layout = {
    //                        .sizing = { .width = CLAY_SIZING_GROW(0), .height =
    //                        CLAY_SIZING_FIXED(0) }, .padding = { 0, 0, 16, 16 }, .childGap = 16,
    //                        .layoutDirection = CLAY_TOP_TO_BOTTOM,
    //                    },
    //                })
    //            {
    ...
    //                            .layout = {
    //                                .sizing = { .width = CLAY_SIZING_GROW(0), .height =
    //                                CLAY_SIZING_FIXED(0) }, .childGap = 4, .layoutDirection =
    //                                CLAY_TOP_TO_BOTTOM,
    //                            },
    //                        })
    //                    {
    ...
    //                                  }));
    //                        CLAY_TEXT(
    //                          CLAY_STRING("Assign squad to start progressing through the
    //                          mission"), CLAY_TEXT_CONFIG({
    //                            .textColor = { 255, 255, 255, 255 },
    //                            .fontId    = 0,
    //                            .fontSize  = 12,
    //                          }));
    ...
    //                            .layout = {
    //                                .sizing = { .width = CLAY_SIZING_GROW(0), .height =
    //                                CLAY_SIZING_GROW(0) }, .childGap = 16, .layoutDirection =
    //                                CLAY_TOP_TO_BOTTOM,
    //                            },
    //                            .backgroundColor = { 22, 41, 151, 255 },
